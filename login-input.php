...
<section class="login_sec">
  ...
  <div class="login_text_block">
    <div class="login_block">
      <span class="login_input_text">メールアドレス</span><br><input type="text" name="mail" class="login_mail"><br>
      <span class="login_input_text">パスワード</span><br><input type="password" name="password" class="login_password"><br>
    </div>
  </div>
